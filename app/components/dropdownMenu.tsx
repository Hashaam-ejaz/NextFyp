...
const DropdownMenu = () => {
  ...
  const mouseOver = (
    ...
    console.log(
      "subcategory: ",
      CategoriesName.Categories[mainCategoryIndex].subCategories[0].name
    );
  ...
  return (
    <>
      ...
      <div
        id="dropdownHead"
        className="w-auto h-[2/3] select-none group/mainDiv  bg-purple-200  "
      >
        ...
        <div className="flex justify-end">
          <button
            id="category-btn"
            className=" justify-end shrink text-[#806491] text-sm border-[#806491] border-[0.8px] rounded-md p-1 pl-2 hover:ring-1 hover:ring-[#806491] md:bg-white "
          >
        ...
        <div
          id="category-div"
          className="hidden group-hover/mainDiv:block bg-green-300 relative"
        >
          <div
            ref={mainDivRef}
            onMouseOver={() => handleMouseOverMainCategoryDiv()}
            id="mainCategoryMenu"
            className="  bg-pink-400 border-[0.8px] rounded-md mt-[8px] p-2 group/mainCategory "
          >
            {CategoriesName.Categories.map((category, keyIndex) => (
              <div
                key={keyIndex}
                className="relative p-2 text-sm text-[#806491] hover:bg-gray-100/50 hover:p-2 cursor-pointer bg-yellow-200 group/individualMainCategory"
              ...
              >
                ...
                <Image
                  src={ExpandLogo}
                  alt="expandMoreLogo"
                  className={` invisible inline-block ml-1 -rotate-90 bg-pink-500 group-hover/individualMainCategory:visible ${
                ...
                <div
                  ref={subDivRef}
                  id="subcategoryMenu"
                  className={`absolute w-full hidden group-hover/mainCategory:block bg-white  border-[0.8px] rounded-md mt-[8px] p-2 top-0 ${
                ...
                >
                  {CategoriesName.Categories[
                    ...
                    <div
                      key={index}
                      className=" p-2 text-sm text-[#806491] hover:bg-gray-100/50 cursor-pointer hover:p-2 bg-lime-200"
                    >
