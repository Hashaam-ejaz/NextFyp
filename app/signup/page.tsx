...
<div className="mb-4 w-full md:w-[24.752rem]"> {/* Adjust width for larger screens */}
        ...
        <button className="text-white mt-2 px-4 py-3 rounded-lg shadow bg-[#806491] rounded-md-[0.375] w-full md:w-[24.752rem] h-[2.75rem] md:mt-[3.438rem]">Sign Up</button>
        ...
        <div className="mt-10">
          Already have an account? <Link className="text-[#806491]" href="/signup">Sign in now!</Link>
        </div>
      </div>
    </div> 
  );
