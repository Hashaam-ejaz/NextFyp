...
const Login = () => {
  return (
    ...
    <div className="hidden md:flex flex-col items-center justify-center h-screen md:w-1/2">
        ...
        <p className="text-black text-xl mt-5">Your <span className="text-[#806491]">Slogan</span> goes here</p>
        <p className="text-black mt-20">Welcome to <span className="text-[#806491]">Logoipsum</span></p>
      </div>
  ...
  />
        ...
        <div className="mb-4 w-full md:w-[24.752rem]"> {/* Adjust width for larger screens */}
          <input 
            type="email" 
        ...
        <div className="flex items-center mb-1 mt-5">
          ...
          <Link href="#" className="text-[#806491] ml-20">Forgot password?</Link>
        </div>
        <button className="text-white mt-4 px-4 py-3 rounded-lg shadow bg-[#806491] rounded-md-[0.375] w-full md:w-[24.752rem] h-[2.75rem] md:mt-[3.438rem]">Sign in</button>
        ...
        <div className="mt-10">
          Don &apos t have an account? <Link className="text-[#806491]" href="#">Sign up now!</Link>
        </div>
      </div>
    </div> 
  );
